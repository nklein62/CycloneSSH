...
//Legacy RC4 cipher support (insecure)
...
//Pure post-quantum key exchange support
#ifndef SSH_KEM_KEX_SUPPORT
   #define SSH_KEM_KEX_SUPPORT DISABLED
#elif (SSH_KEM_KEX_SUPPORT != ENABLED && SSH_KEM_KEX_SUPPORT != DISABLED)
   #error SSH_KEM_KEX_SUPPORT parameter is not valid
#endif
...
//Maximum shared secret length (pure post quantum key exchange)
#if (SSH_KEM_KEX_SUPPORT == ENABLED)
   #define SSH_MAX_KEM_SHARED_SECRET_LEN 36
#else
   #define SSH_MAX_KEM_SHARED_SECRET_LEN 0
#endif

//Maximum shared secret length (post quantum hybrid key exchange)
...
//Maximum shared secret length
   ...
   SSH_MAX_RSA_SHARED_SECRET_LEN >= SSH_MAX_KEM_SHARED_SECRET_LEN && \
   ...
   SSH_MAX_DH_SHARED_SECRET_LEN >= SSH_MAX_KEM_SHARED_SECRET_LEN && \
   ...
   SSH_MAX_ECDH_SHARED_SECRET_LEN >= SSH_MAX_KEM_SHARED_SECRET_LEN && \
...
#elif (SSH_MAX_KEM_SHARED_SECRET_LEN >= SSH_MAX_RSA_SHARED_SECRET_LEN && \
   SSH_MAX_KEM_SHARED_SECRET_LEN >= SSH_MAX_DH_SHARED_SECRET_LEN && \
   SSH_MAX_KEM_SHARED_SECRET_LEN >= SSH_MAX_ECDH_SHARED_SECRET_LEN && \
   SSH_MAX_KEM_SHARED_SECRET_LEN >= SSH_MAX_HYBRID_SHARED_SECRET_LEN)
   #define SSH_MAX_SHARED_SECRET_LEN SSH_MAX_KEM_SHARED_SECRET_LEN
#else
...
typedef enum
{
   ...
   SSH_MSG_KEX_KEM_INIT              = 30,
   SSH_MSG_KEX_KEM_REPLY             = 31,
...
typedef enum
{
   ...
   SSH_CONN_STATE_KEX_KEM_INIT       = 16,
   SSH_CONN_STATE_KEX_KEM_REPLY      = 17,
   SSH_CONN_STATE_KEX_HYBRID_INIT    = 18,
   SSH_CONN_STATE_KEX_HYBRID_REPLY   = 19,
   SSH_CONN_STATE_CLIENT_NEW_KEYS    = 20,
   SSH_CONN_STATE_SERVER_NEW_KEYS    = 21,
   SSH_CONN_STATE_CLIENT_EXT_INFO    = 22,
   SSH_CONN_STATE_SERVER_EXT_INFO_1  = 23,
   SSH_CONN_STATE_SERVER_EXT_INFO_2  = 24,
   SSH_CONN_STATE_SERVICE_REQUEST    = 25,
   SSH_CONN_STATE_SERVICE_ACCEPT     = 26,
   SSH_CONN_STATE_USER_AUTH_BANNER   = 27,
   SSH_CONN_STATE_USER_AUTH_REQUEST  = 28,
   SSH_CONN_STATE_USER_AUTH_REPLY    = 29,
   SSH_CONN_STATE_USER_AUTH_SUCCESS  = 30,
   SSH_CONN_STATE_OPEN               = 31,
   SSH_CONN_STATE_DISCONNECT         = 32
} SshConnectionState;
